...
PRICE_META: Dict[str, Dict[str, str]] = {
    ...
    "beregening_installatie_basis":               {"unit": "€ vast", "label": "Installatie – Basis (deels handmatig)"},
    "beregening_installatie_volautomatisch":      {"unit": "€ vast", "label": "Installatie – Volautomatisch (tijdschema)"},
    "beregening_installatie_highend":             {"unit": "€ vast", "label": "Installatie – Smart (app/wifi/weer-gestuurd)"},
    "beregening_gazon_basis_per_m2":              {"unit": "€/m²", "label": "Gazon – Basis (deels handmatig)"},
    "beregening_gazon_volautomatisch_per_m2":     {"unit": "€/m²", "label": "Gazon – Volautomatisch (tijdschema)"},
    "beregening_gazon_highend_per_m2":            {"unit": "€/m²", "label": "Gazon – Smart (app/wifi/weer-gestuurd)"},
    "beregening_beplanting_basis_per_m2":         {"unit": "€/m²", "label": "Beplanting – Basis (deels handmatig)"},
    "beregening_beplanting_volautomatisch_per_m2":{"unit": "€/m²", "label": "Beplanting – Volautomatisch (tijdschema)"},
    "beregening_beplanting_highend_per_m2":       {"unit": "€/m²", "label": "Beplanting – Smart (app/wifi/weer-gestuurd)"},
